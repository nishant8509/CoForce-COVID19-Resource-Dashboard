      ...
      <div class="c">
        <div class="desh">
            ...
            <ul class="ul">
				...
				<a href="m.php"><li  style="background: rgba(255, 115, 0, 0.979);">Medicines</li></a>
				...
				$result=$con->query($raw);
                   ...
                   while($row=$result->fetch_assoc()){?>
                    <div class="list">
                        ...
                        <span style="color: orangered; padding-left: 10px;">Service :</span><span style="padding-right: 10px;"> Medicines Supplier</span>
