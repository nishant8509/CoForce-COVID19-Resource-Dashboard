...
//configure AT
var webURL = 'http://covid19helpdesk.com/menu'
var welcomeMsg = `CON Hello and welcome to Covid-19 USSD Helpdesk.
...
app.post('/order', function(req, res){
    ...
    if(text === ''){
        ...
        message = "CON What problem are you facing?"
        ...
        message = `END Thanks for trusting us, STAY SAFE, STAY HOME`
